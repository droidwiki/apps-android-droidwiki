...
public class AppLanguageLookUpTable {
    ...
    public List<String> getCodes() {
        ...
        if (codes == null) {
            codes = getStringList(resources, de.droidwiki.R.array.preference_language_keys);
    ...
    private List<String> getCanonicalNames() {
        ...
        if (names == null) {
            names = getStringList(resources, de.droidwiki.R.array.preference_language_canonical_names);
    ...
    private List<String> getLocalizedNames() {
        ...
        if (names == null) {
            names = getStringList(resources, de.droidwiki.R.array.preference_language_local_names);
