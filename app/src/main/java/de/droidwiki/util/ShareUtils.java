            ...
            public void onFinish(String result) {
                if (result == null) {
                    Toast.makeText(context,
                            String.format(context.getString(de.droidwiki.R.string.gallery_share_error),
                                    context.getString(de.droidwiki.R.string.err_cannot_save_file)),
                ...
                Intent chooserIntent = Intent.createChooser(shareIntent,
                        context.getResources().getString(de.droidwiki.R.string.share_via));
                context.startActivity(chooserIntent);
            }
