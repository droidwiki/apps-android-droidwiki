...
public abstract class SwipeableBottomDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dialogListView = (ListView) rootView.findViewById(de.droidwiki.R.id.bottom_swipe_container_list);
    ...
    private int getDialogWidth() {
        return Math.min(getResources().getDisplayMetrics().widthPixels,
                (int) getResources().getDimension(de.droidwiki.R.dimen.swipeableDialogMaxWidth));
    }
