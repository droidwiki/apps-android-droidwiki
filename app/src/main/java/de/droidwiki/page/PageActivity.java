...
import de.droidwiki.analytics.WidgetsFunnel;
import de.droidwiki.events.ChangeTextSizeEvent;
import de.droidwiki.events.ThemeChangeEvent;
import de.droidwiki.events.WikipediaZeroStateChangeEvent;
import de.droidwiki.history.HistoryEntry;
import de.droidwiki.interlanguage.LangLinksActivity;
import de.droidwiki.login.LoginActivity;
import de.droidwiki.page.gallery.GalleryActivity;
import de.droidwiki.page.linkpreview.LinkPreviewDialog;
import de.droidwiki.random.RandomHandler;
import de.droidwiki.recurring.RecurringTasksExecutor;
import de.droidwiki.search.SearchArticlesFragment;
...
import de.droidwiki.theme.ThemeChooserDialog;
...
public class PageActivity extends ThemedActionBarActivity {
    ...
    public static final String ACTION_PAGE_FOR_TITLE = "de.droidwiki.page_for_title";
    public static final String EXTRA_PAGETITLE = "de.droidwiki.pagetitle";
    public static final String EXTRA_HISTORYENTRY  = "de.droidwiki.history.historyentry";
