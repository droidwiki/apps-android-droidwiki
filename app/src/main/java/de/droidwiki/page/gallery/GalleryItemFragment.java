package de.droidwiki.page.gallery;
...
public class GalleryItemFragment extends Fragment {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(de.droidwiki.R.id.menu_gallery_visit_page).setEnabled(galleryItem != null);
        menu.findItem(de.droidwiki.R.id.menu_gallery_share).setEnabled(galleryItem != null
                                                          && imageView.getDrawable() != null);
        menu.findItem(de.droidwiki.R.id.menu_gallery_save).setEnabled(galleryItem != null
                                                         && imageView.getDrawable() != null);
    }
        ...
        Picasso.with(parentActivity)
               ...
               .into(imageView, new Callback() {
                   ...
                   public void onError() {
                       ...
                       updateProgressBar(false, true, 0);
                       FeedbackUtil.showMessage(getActivity(), de.droidwiki.R.string.gallery_error_draw_failed);
                   }
               });
    }
    ...
    private void saveImageToMediaStore() {
        ...
        new SaneAsyncTask<Void>(SaneAsyncTask.SINGLE_THREAD) {
            ...
            public Void performTask() throws Throwable {
                ...
                if (url == null) {
                    throw new RuntimeException(getString(de.droidwiki.R.string.gallery_save_error_mediastore));
                }
                return null;
            }
            @Override
            public void onFinish(Void result) {
                ...
                FeedbackUtil.showMessage(parentActivity, de.droidwiki.R.string.gallery_save_success);
            }
            @Override
            public void onCatch(Throwable caught) {
                if (!isAdded()) {
