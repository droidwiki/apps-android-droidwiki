...
public class EditSummaryHandler {
    ...
    public EditSummaryHandler(final Activity activity, View container,
        ...
        if (!ApiUtil.hasHoneyComb()
            ...
            summaryEdit.setHintTextColor(activity.getResources()
                .getColor(Utils.getThemedAttributeId(activity, de.droidwiki.R.attr.edit_text_color)));
        }
    ...
    public void persistSummary() {
        ...
        app.getPersister(EditSummary.class).upsert(summary, EditSummary.PERSISTENCE_HELPER.SELECTION_KEYS);
    }
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            ...
            if (!ApiUtil.hasHoneyComb()) {
                ...
                rootView.setBackgroundColor(activity.getResources().getColor(
                        Utils.getThemedAttributeId(activity, de.droidwiki.R.attr.window_background_color)));
            }
            return rootView;
        }
