package de.droidwiki.pagehistory.usercontributions;
...
import de.droidwiki.pagehistory.PageHistoryItem;
...
public class UserContribsActivity extends ThemedActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(de.droidwiki.R.layout.activity_user_contribs);

        app = (WikipediaApp)getApplicationContext();

        moreContainer = getLayoutInflater().inflate(de.droidwiki.R.layout.group_load_more, null, false);
        moreText = (TextView) moreContainer.findViewById(de.droidwiki.R.id.load_more_text);
        moreProgress = (ProgressBar) moreContainer.findViewById(de.droidwiki.R.id.load_more_progress);
        ...
        ListView userContribsList = (ListView) findViewById(de.droidwiki.R.id.user_contribs_list);
    ...
    private class UserContribsAdapter extends BaseAdapter{
        ...
        public View getView(int pos, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = getLayoutInflater().inflate(de.droidwiki.R.layout.item_usercontribs_entry, parent, false);
            }

            TextView titleText = (TextView) convertView.findViewById(de.droidwiki.R.id.user_contrib_item_page_name);
            TextView summaryText = (TextView) convertView.findViewById(de.droidwiki.R.id.user_contrib_item_edit_summary);
            TextView timeAgoText = (TextView) convertView.findViewById(de.droidwiki.R.id.user_contrib_item_time_ago);
