...
public class ImageUrlMapTests extends TestCase {
    ...
    public void testNonClosedImgTag() throws Exception {
        ...
        builder.extractUrlsInSection(
                ...
                + "<img alt=\"Frederick Delius\" src=\"//upload.wikimedia.de.droidwiki/en/thumb/7/79/foo.jpg\" "
                + "width=\"100\" height=\"148\" srcset=\"//upload.wikimedia.de.droidwiki/en/thumb/7/79/foo.jpg/150px-foo.jpg 1.5x, "
                + "//upload.wikimedia.de.droidwiki/en/thumb/7/79/Fritz_Delius_%281907%29.jpg/200px-Fritz_Delius_%281907%29.jpg 2x\" \n"
                + "data-file-width=\"1596\" data-file-height=\"2368\"></a></div>\n"
                + "<img alt=\"Maria Sharapova in 2008\" src=\"//upload.wikimedia.de.droidwiki/en/thumb/c/c6/bar.jpg/bar.jpg\" "
                + "width=\"61\" height=\"100\" class=\"thumbborder\" "
                + "srcset=\"//upload.wikimedia.de.droidwiki/en/thumb/c/c6/bar.jpg/91px-bar.jpg 1.5x, "
                + "//upload.wikimedia.de.droidwiki/en/thumb/c/c6/bar.jpg/121px-bar.jpg 2x\" data-file-width=\"405\" \n"
